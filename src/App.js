...
function App() {
  ...
  const homeScore = 0;
  const [hScore, setHScore] = useState(homeScore);
  const awayScore = 0;
      ...
      <section className="scoreboard">
        <div className="topRow">
          <div className="home">
            ...
            <div className="home__score"><span>{hScore}</span></div>
          </div>
          <Timer />
          ...
          <div className="away">
            ...
            <div className="away__score"><span>{aScore}</span></div>
          </div>
        </div>
        <BottomRow />
      </section>
      <section className="buttons">
        <button className="buttons" onClick={() => setHScore(0)}>Reset HomeScore</button>
        ...
        <button className="buttons" onClick={() => setAScore(0)}>Reset AwayScore</button>
